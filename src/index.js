...
import candidateAdd from './app/components/candidate-add.module.js';
...
angular
  .module('app', [techsModule, 'ui.router', elections, voters, candidatesList, voterDetail, candidateAdd, coreShared, candidateVote])
  .config(routesConfig)
  .component('app', main)
